 ...
 * ASAP_REFBOOK:
 *   domain: HTTP
 *   role: Class Response belongs to the HTTP ASAP framework domain.
 *   contract:
...
final class Response
{
    ...
    #[AsapRefBookMethod(
        ...
        sideEffects: ['none'],
        errors: ['ASAP_RESPONSE_STATUS_INVALID'],
    ...
    #[AsapRefBookMethod(
        ...
        sideEffects: ['none'],
        errors: ['JSON_THROW_ON_ERROR', 'ASAP_RESPONSE_STATUS_INVALID'],
        testRefs: ['tests/Contract/RefBookHttpMetadataContractTest.php'],
