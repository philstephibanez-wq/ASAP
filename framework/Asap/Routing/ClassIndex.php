 ...
 * ASAP_REFBOOK:
 *   domain: ROUTING
 *   role: Class ClassIndex belongs to the ROUTING ASAP framework domain.
 *   contract:
...
final class ClassIndex implements RefBookInspectableInterface
{
    ...
    #[AsapRefBookMethod(
        ...
        sideEffects: ['none'],
        errors: ['ASAP_CLASS_INDEX_CLASS_INVALID', 'ASAP_CLASS_INDEX_PATH_INVALID'],
        testRefs: ['tests/Contract/RefBookRoutingMetadataContractTest.php'],
    ...
    #[AsapRefBookMethod(
        ...
        sideEffects: ['none'],
        errors: ['ASAP_CLASS_INDEX_NAMESPACE_EMPTY'],
        testRefs: ['tests/Contract/RefBookRoutingMetadataContractTest.php'],
        examples: ['attribute-routing'],
        diagrams: ['routing-runtime'],
        introducedIn: 'P112Q3E3'
