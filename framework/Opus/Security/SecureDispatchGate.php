 ...
 * OPUS_REFBOOK:
 *   domain: SECURITY
 *   role: Class SecureDispatchGate belongs to the SECURITY Opus framework domain.
 *   contract:
...
final class SecureDispatchGate
{
    ...
    private function resolveAclTriplet(SiteSecurityPolicy $policy, RouteMatch $match): array
    {
        ...
        throw ContractException::because('OPUS_ROUTE_ACL_METADATA_INVALID', $match->name . ' => ' . $routeAcl);
    }
}
