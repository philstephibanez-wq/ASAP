...
set "RECIPE=%ASAP_ROOT%\tests\recipe\p112q2e_bdd_to_database_english_domain_rename_recipe.php"

echo P112Q2E_BDD_TO_DATABASE_ENGLISH_DOMAIN_RENAME_RECIPE_START
...
echo P112Q2E_BDD_TO_DATABASE_ENGLISH_DOMAIN_RENAME_RECIPE_OK
exit /b 0
...
:recipe_missing
echo P112Q2E_RECIPE_MISSING
exit /b 1

:recipe_failed
echo P112Q2E_RECIPE_FAILED
exit /b 1
