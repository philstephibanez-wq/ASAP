...
set "RECIPE=%ASAP_ROOT%\tests\recipe\p112q2g_root_namespace_and_render_cleanup_recipe.php"
...
if exist "%ASAP_ROOT%\tools\automation\p112q2e_bdd_to_database_english_domain_rename_recipe_runner.cmd" (
    call "%ASAP_ROOT%\tools\automation\p112q2e_bdd_to_database_english_domain_rename_recipe_runner.cmd" || goto q2e_recipe_failed
)

if exist "%ASAP_ROOT%\tools\automation\p112q2d_namespace_directory_case_normalization_recipe_runner.cmd" (
    call "%ASAP_ROOT%\tools\automation\p112q2d_namespace_directory_case_normalization_recipe_runner.cmd" || goto q2d_recipe_failed
)

if exist "%ASAP_ROOT%\tools\automation\p112q2c_mixed_namespace_directory_reconciliation_recipe_runner.cmd" (
    call "%ASAP_ROOT%\tools\automation\p112q2c_mixed_namespace_directory_reconciliation_recipe_runner.cmd" || goto q2c_recipe_failed
)
