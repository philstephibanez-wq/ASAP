...
set "RECIPE=%ASAP_ROOT%\tests\recipe\p112q2d_namespace_directory_case_normalization_recipe.php"

echo P112Q2D_NAMESPACE_DIRECTORY_CASE_NORMALIZATION_RECIPE_START
...
echo P112Q2D_NAMESPACE_DIRECTORY_CASE_NORMALIZATION_RECIPE_OK
exit /b 0
...
:recipe_missing
echo P112Q2D_RECIPE_MISSING
exit /b 1

:recipe_failed
echo P112Q2D_RECIPE_FAILED
exit /b 1
