...
/**
 * P113D1C ASAP RefBook REST API smoke.
 *
 * Public smoke test.
 * Contract:
...
$required = [
    ...
    'framework/Asap/RefBook/Api/RefBookRestApi.php',
    'public/api/refbook.php',
    'tools/server/asap_refbook_rest_router.php',
    ...
    'DOC/patches/P113D1_ASAP_REFBOOK_REST_API/PATCH.md',
    'DOC/patches/P113D1_ASAP_REFBOOK_REST_API/CHANGELOG.md',
];
...
$globalRecipe = readText($root, 'tools/recipes/asap_global_regression_recipe.php');
...
$provider = readText($root, 'framework/Asap/RefBook/Api/RefBookRestSnapshotProvider.php');
...
$api = readText($root, 'framework/Asap/RefBook/Api/RefBookRestApi.php');
...
echo 'P113D1_ASAP_REFBOOK_REST_API_SMOKE_OK' . PHP_EOL;
exit(0);
